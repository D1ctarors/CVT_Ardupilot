...
// Hydrogen Fuel Cell RU
#define AP_SERIALMANAGER_HYDROGEN_BUFSIZE_RX 128
#define AP_SERIALMANAGER_HYDROGEN_BUFSIZE_TX 128
#define AP_SERIALMANAGER_HYDROGEN_BAUD 57600
